...
object CraftEngineBundleGenerator {
    private fun formatTileLabel(name: String): String = name.split('_').joinToString(" ") { part ->
        part.replaceFirstChar { if (it.isLowerCase()) it.titlecase() else it.toString() }
    }
    
    fun writeCraftEngineBundle(enumSource: File, resourcepackDir: File, attributionFile: File, outputDir: File, projectVersion: String) {
        ...
        val tileNames = MahjongCodegen.parseMahjongTileNames(enumSource).toMutableSet().apply {
            add("back")
        }.sorted()
